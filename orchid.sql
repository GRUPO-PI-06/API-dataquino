...
INSERT INTO cadastro (empresa, cnpj, email, telefone, cep, senha)
VALUES ('Orquidário Sol Nascente', '12345678000199', 'contato@solnascente.com', '11999998888', '12345678', 'senha123');

INSERT INTO orquidario (nome_orquidario, logradouro, numero, bairro, cidade, estado, cep, fk_especie, fk_cadastro, descricao_local)
VALUES ('Estufa A', 'Rua das Orquídeas', 123, 'Jardim Florido', 'Campinas', 'SP', '12345678', 3, 1, 'Estufa principal da propriedade');
INSERT INTO sensor (status_sensor, fk_orquidario, fk_cadastro)
VALUES ('Ativo', 1, 1);

select * from registro_luminosidade;
TRUNCATE registro_luminosidade;
